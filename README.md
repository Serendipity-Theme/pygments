...
Import the style class in your Pygments config or Sphinx `pygments_style`.

Available files: `serendipity_midnight.py`, `serendipity_morning.py`, `serendipity_sunset.py`.
